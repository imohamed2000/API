                    ...
                    <div class="container-fluid">
                        <div class="clearfix navbar-fixed-top">
                            ...
                            <a id="index" class="page-logo" href="index.html">
                                <img src="/layouts/layout5/img/logo.png" alt="Logo"> </a>
                            <!-- END LOGO -->
                            <!-- BEGIN SEARCH -->
                            ...
                            <div class="topbar-actions">
                                ...
                                <div class="btn-group-img btn-group">
                                    <button type="button" class="btn btn-sm md-skip dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                        <span>Hi, Marcus</span>
                                        <img src="/layouts/layout5/img/avatar1.jpg" alt=""> </button>
                                    <ul class="dropdown-menu-v2" role="menu">
                                        <li>
                        ...
                        <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                            ...
                            <ul class="media-list list-items">
                                <li class="media">
                                    ...
                                    <img class="media-object" src="/layouts/layout5/img/avatar1.jpg" alt="...">
                        ...
                        <div class="page-quick-sidebar-item">
                            <div class="page-quick-sidebar-chat-user">
                                ...
                                <div class="page-quick-sidebar-chat-user-messages">
                                    <div class="post out">
                                        <img class="avatar" alt="" src="/layouts/layout5/img/avatar1.jpg" />
                                        <div class="message">
