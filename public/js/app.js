...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('docs', __webpack_require__(12));
...
module.exports = [{ path: '/', component: __webpack_require__(0), name: 'example' }, { path: '/docs', component: __webpack_require__(12), name: 'docs' }];
